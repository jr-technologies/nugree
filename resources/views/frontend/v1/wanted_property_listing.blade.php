                ...
                @foreach($response['data']['properties'] as $property)
                    ...
                    <article class="publicProperty-post">
                        ...
                        <div class="caption text-left">
                            <div class="layout">
                                <h1><a href="{{URL::to('property').'/'.$property->slug}}">{{ ''.$property->land->area.' '.$property->land->unit->name .' '}}{{$property->type->subType->name.' '.(($property->wanted)?'required ':'').'in '.$property->location->location->location." ".'('.$property->location->city->name.')'}}</a></h1>
