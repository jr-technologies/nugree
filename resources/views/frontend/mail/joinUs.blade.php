        ...
        <div style="  margin: 0;padding: 0;">
            <div style="margin:0 auto;padding:20px 0; max-width:800px;">
                <div style=" color:#000;   font-family: 'Raleway', sans-serif;">
                    <p style="    margin: 0;padding:0 ;max-width: 700px;">- <b style="color:#64719a;font-weight:bold;font-size:15px;"></b>,</p>

                    <p>Email : {{$userRequirement->email}}.</p>
                    <p>Name : {{$userRequirement->name}}.</p>
                    <p>Phone : {{$userRequirement->phone}}.</p>
                    <p>Message : {{$userRequirement->message}}.</p>
                    <p>Address : {{$userRequirement->address}}.</p>
                    <p>Requirement : {{$userRequirement->purposeId}}.</p>
