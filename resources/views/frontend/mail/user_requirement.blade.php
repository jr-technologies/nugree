...
<div id="wrapper" style="max-width: 600px; margin: 30px auto; overflow: hidden; background: #fff; position: relative; z-index: 99;">
    <div class="logo" style=" width: 209px; margin: 0 auto;"><a href="#" style=" display: block;">
            <img src="{{url('/').'/web-aaps/frontend/assets/images/logo.png'}}" alt="nugree.com" width="209" height="54" style=" display: block; width: 100%; height: auto;"></a></div>
    <div class="layout" style="padding: 50px 0;">
        ...
        <strong>Email : {{$userRequirement->email}}.</strong>
            <strong>Name : {{$userRequirement->name}}.</strong>
                <strong>Phone : {{$userRequirement->phone}}.</strong>
        <strong>Subject : {{$userRequirement->subject}}.</strong>
        <strong>Requirement : {{$userRequirement->requirement}}.</strong>
